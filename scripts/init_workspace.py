...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create a blank ABM Engine research workspace.")
    ...
    print("Use the repository CLI for signal search and query rendering.")
    return 0
